...
void initialize_mpu1 () {
  ...
  if (devStatus == 0) {
    ...
    Serial.println(F(")"));
    bot.sendMessage(chat_id, "not good", "");
  }
}
...
void handleNewMessages(int numNewMessages)
{
  ...
  for (int i = 0; i < numNewMessages; i++)
  {
    ...
    if ((text == "/calibration_of_sensors") || (text == "calibration_of_sensors"))
      ...
      if ((text == "/mpu1_initialize") || (text == "mpu1_initialize"))
        {
            initialize_mpu1();
            initialize_mpu2();
   ...
   if ((text == "/start") || (text == "start") || (text == "/help") || (text == "help"))
    {
      ...
      welcome += "/mpu1_initialize или /mpu1_initialize - включить/выключить светодиод", "";
